module Ebay # :nodoc:
  module Types # :nodoc:
    class AccountDetailEntryCode
      ...
      PaymentIntermediationFeeCredit = 'PaymentIntermediationFeeCredit'
      ...
      AdFeePremium = 'AdFeePremium'
      AdFeePremiumCredit = 'AdFeePremiumCredit'
      PerListingPaymentsFee = 'PerListingPaymentsFee'
      PerListingPaymentsFeeCredit = 'PerListingPaymentsFeeCredit'
      VehiclesListingBasicPackageFee = 'VehiclesListingBasicPackageFee'
      VehiclesListingBasicPackageCredit = 'VehiclesListingBasicPackageCredit'
      VehiclesListingPlusPackageFee = 'VehiclesListingPlusPackageFee'
      VehiclesListingPlusPackageCredit = 'VehiclesListingPlusPackageCredit'
      VehiclesListingPremiumPackageFee = 'VehiclesListingPremiumPackageFee'
      VehiclesListingPremiumPackageCredit = 'VehiclesListingPremiumPackageCredit'
      SendLabelFee = 'SendLabelFee'
      SendLabelFeeCredit = 'SendLabelFeeCredit'
      UpsLabelFee = 'UpsLabelFee'
      UpsLabelFeeCredit = 'UpsLabelFeeCredit'
      CanadaPostLabelFee = 'CanadaPostLabelFee'
      CanadaPostLabelFeeCredit = 'CanadaPostLabelFeeCredit'
      eBaySendLabelFee = 'EbaySendLabelFee'
      eBaySendLabelFeeCredit = 'EbaySendLabelFeeCredit'
      USInternetSalesTax = 'USInternetSalesTax'
      USInternetSalesTaxCredit = 'USInternetSalesTaxCredit'
      NewZealandGST = 'NewZealandGST'
      NewZealandGSTCredit = 'NewZealandGSTCredit'
      AustraliaGST = 'AustraliaGST'
      AustraliaGSTCredit = 'AustraliaGSTCredit'
      CoFundingCharge = 'CoFundingCharge'
      CoFundingChargeCredit = 'CoFundingChargeCredit'
    end
  end
end
